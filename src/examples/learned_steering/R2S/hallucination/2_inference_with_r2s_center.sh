...
# STEERING_VECTORS=/research/hal-afsharim/learn-to-steer/Hallucination/POPE/hallucination/shift_vectors/qwen2vlinstruct_17_100mean_replicated_6300.pth
...
# --> NEW: Point to your saved global center <--
# GLOBAL_CENTER_PATH=/research/hal-afsharim/learn-to-steer/Hallucination/POPE/hallucination/shift_vectors/qwen2vlinstruct_17_global_center_train_data.pth
GLOBAL_CENTER_PATH=None # means no global center
# global_center_base_name=$(basename "$GLOBAL_CENTER_PATH" .pth)
...
for split in adversarial popular random; do
    for i in 17; do
        for theta in "${thetas[@]}"; do
            shift_vector_path=${STEERING_VECTORS}
            # global_center_path=${GLOBAL_CENTER_PATH}
