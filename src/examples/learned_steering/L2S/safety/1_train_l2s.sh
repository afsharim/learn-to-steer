...
for split in multi; do
    ...
    for i in 15; do
        ...
        cxt_features_name=save_hidden_states_for_l2s_qwen_mmsb_features_context_14_multi_all_-1.pth # For Qwen-mmsb
        modules_to_hook="model.layers.14;model.layers.14" # For Qwen
...
#         modules_to_hook="language_model.model.layers.${i};language_model.model.layers.30"
#         modules_to_hook="model.layers.14;model.layers.14" # For Qwen
#         save_filename=${split}_mmsb_train_-1_v2
