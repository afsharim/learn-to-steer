...
max_new_tokens=200
steering_alpha=1
hook_names=("save_hidden_states_given_token_idx" "shift_hidden_states_add" "safety_metrics")
...
for split in multi; do
    ...
    for steering_alpha in 1; do
        ...
        for method in shift_of_means; do
            ...
            save_filename="${model}_${dataset_name}_steer_${method}_${split}_${steering_alpha}_${steer_model_base}.pth"
            modules_to_hook="language_model.model.layers.15;language_model.model.layers.15" # Used for LLaVA experiments (MMSafety)
