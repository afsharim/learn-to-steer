...
STEERING_VECTORS=/research/hal-afsharim/learn-to-steer/id_steering/test_code/qwen2vlinstruct_14_last_input_multi_mmsb_train_-1_test.pth
...
max_new_tokens=200
steering_alpha=2.2
hook_names=("shift_hidden_states_add")
...
for split in multi; do
    ...
    for steering_alpha in 2.2; do
        ...
        for method in shift_of_means; do
            ...
            save_filename="${model}_${dataset_name}_steer_${method}_${split}_${steering_alpha}_${steer_model_base}.pth"
            # modules_to_hook="language_model.model.layers.15" # Used for LLaVA experiments (MMSafety)
