...
for split in adversarial popular random; do
    ...
    for i in 14; do
        STEERING_VECTORS=/research/hal-afsharim/learn-to-steer/Hallucination/POPE/hallucination/shift_vectors/llava_14_per_sample_pope_test_${split}_-1_pos_minus_x_prompt.pth
        steering_vectors_base_name=$(basename "$STEERING_VECTORS" .pth)
