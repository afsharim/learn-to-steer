...
STEER_MODEL_NAME=/research/hal-afsharim/learn-to-steer/Hallucination/POPE/hallucination/hallucination_steering_net/llava_14_average_all_pope_train_-1.pt
...
for split in descriptive; do
    ...
    for i in 14; do
        ...
        save_filename="${model}_${dataset_name}_steer_${i}_yes_no_${split}_${steering_alpha}_${steer_model_base}_${max_new_tokens}"
...
# STEER_MODEL_NAME=/research/hal-afsharim/learn-to-steer/Hallucination/POPE/hallucination/hallucination_steering_net/qwen2vlinstruct_17_average_all_pope_train_-1.pt
